                    ...
                    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                      {Object.keys(templates).map(t => (
                        <button key={t} onClick={() => {
                          ...
                          setReplyBody(tmpl.body.replace(/{company}/g, detailModal.companyName || '').replace(/{name}/g, detailModal.contactPerson || '').replace(/{employee_name}/g, detailModal.assignedAsset || 'Employee'));
